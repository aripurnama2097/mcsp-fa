...
function splitLabel(){
    ...
    label_original = label_original.replaceAll("+","#");
    label_picking = label_picking.replaceAll("+","#");
    // console.log({part_number,label_original,label_picking});
    // return;
    if(label_original !== label_picking){
    ...
    if(label_original.search(part_number)>= 0){
        ...
        success : function(response){
            ...
            part_number = part_number.replaceAll("+","__");
            label_balance = label_balance.replaceAll("+","__");
            label_sorting = label_sorting.replaceAll("+","__");

            console.log("print_partnumber",part_number);
            console.log("print_label_balance",label_balance);
            console.log("print_label_sorting",label_sorting);
            // return;
