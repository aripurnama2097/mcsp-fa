...
<head>
    ...
    <!-- notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset ('') }}css/notika-custom-iconSSSS.css">
    <!-- wave CSS
		============================================ -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a style ="color:white " href="#" class="text-align:center"><i class="bi bi-box-seam-fill"></i>  MC SORTING PART</a> 
                    </div>
                </div>
                        ...
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#democrou" href="#">Register Part</a>
                                    ...
                                    <li><a href="register_part/progress.blade.php">REGISTER PART</a>
                                     </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a data-toggle="tab" href="#Home"><i class="bi bi-house-door-fill"></i></i> Home</a>
                        </li>

                        <li><a data-toggle="tab" href="#Register_part"><i class="bi bi-card-text"></i></i> Register Part</a>
                        </li>

                        <li><a data-toggle="tab" href="#Forms"><i class="bi bi-box-seam-fill"></i></i> Picking Part</a>
                        </li>
                        <li><a data-toggle="tab" href="#SortingPart"><i class="{{asset ('') }}notika-icon notika-app"></i>Sorting Part</a>
                        </li>
                        <li><a data-toggle="tab" href="#RecordData"><i class="bi bi-sticky"></i></i> Record Data</a>
                        </li>
                        <li><a data-toggle="tab" href="#Forms"><i class="bi bi-clipboard2-minus"></i></i>Manual Instruction</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Register_part" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="/dashboard/register_part">REGISTER PART</a>
                                </li>
                                <li><a href="google-map.html">UPDATE PROGRESS</a>
                                </li>
